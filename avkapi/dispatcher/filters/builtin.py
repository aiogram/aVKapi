...
from avkapi.dispatcher.filters.filters import BoundFilter, Filter
from avkapi.types import Message
...
class StateFilter(BoundFilter):
    ...
    def __init__(self, dispatcher, state):
        from avkapi.dispatcher.filters.state import State, StatesGroup
